---
title: "The PMP Exam Lens Cheat Sheet"
subtitle: "How PMI actually grades your thinking — with 5 worked scenarios"
...
> **How PMI actually grades your thinking — with 5 worked scenarios.**
...
## The Bloom's layer (one more thing before the scenarios)
...
> A vendor delivering a critical integration component missed their committed milestone by two weeks. Your project is now at risk of slipping. What is your **first** action?
...
First, the math:
- Expected monetary value (EMV) of the risk = 30% × $500,000 = **$150,000**
...
The answer hides behind a procedure ("submit a formal change request," "refer to the contract," "use the escalation matrix"). **Often wrong when the situation calls for engagement.** Examples: 1A, 2A.
...
The answer is too big or too small for the situation — "replace the team member" for three missed meetings, "reopen risk identification for the whole project" for one mis-estimated risk. **Wrong when the situation has a calibrated middle-ground option.** Examples: 4A, 5D.
...
That's exactly what CipherExam is built for.

Every PMP question in CipherExam:
- Is classified by Bloom's level (so you can target the Evaluate-level questions where the lens matters most)
- Comes with an Exam Lens walk-through (every right and wrong answer is explained through the lens)
- Surfaces your personal "thinking traps" (the patterns where you keep falling into Trap 1, 2, 3, or 4)
- Builds toward a 180-question Full Mock with EMV math support — the same length and pacing as the actual PMP

**Start your 7-day free trial. No credit card.**

→ **[cipherexam.com/lp/pmp](https://cipherexam.com/lp/pmp?utm_source=lead-magnet&utm_campaign=pmp-cheat-sheet&utm_content=cta)**
