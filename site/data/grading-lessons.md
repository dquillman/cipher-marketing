...
- **The 48-hour grading floor is too short for this account and every grade on file is understating its post.** `li-thu-2026-08-07-sponsor-scenario` has now been measured three times and grown at every reading: **732 impressions at its 08-10 grading → 1,220 when this file was written → 2,134 on 08-12.** That is 2.9x growth *after* the grade was assigned. Because grades feed this file and this file constrains `draft-week-posts`, understated numbers propagate into drafting rules. **Move the grading floor from 48 hours to 7 days**, and re-grade any post whose lesson depends on its absolute reach. Corollary for anyone reading a grade: a D assigned at 48h on this account is not yet evidence of a bad post.
